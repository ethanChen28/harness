...
> **Harness is a team-architecture factory for Claude Code.** Say **"build a harness for this project"** (English) or **"配置一下 Harness"** (中文) or **"ハーネスを構成して"** (日本語), and the plugin turns your domain description into an agent team and the skills they use — picked from six pre-defined team-architecture patterns.
